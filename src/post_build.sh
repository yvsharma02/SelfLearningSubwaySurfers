...
cp $WORK_DIR/emulator_controller.proto $WORK_DIR/../post_build/emulator_controller.proto
...
python -m grpc_tools.protoc -I $WORK_DIR/../post_build --python_out=$WORK_DIR/src/emulator_controller --grpc_python_out=$WORK_DIR/src/emulator_controller emulator_controller.proto
